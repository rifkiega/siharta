        ...
        <div class="card-body">
            <form action="tambah_penghasilan_profesi" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="lembaga" type="text" class="form-control" id="exampleFormControlInput1"
                            placeholder="lembaga">
                    </div>
                </div>
                ...
                <div class="mt-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input required name="penghasilan_bersih" type="number" class="form-control"
                            id="exampleFormControlInput1" placeholder="penghasilan_bersih">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <center>
                        ...
                        <a href="/print_penghasilan_profesi" class="btn btn-success">Print</a>
