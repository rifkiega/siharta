...
<div class="container-fluid px-4">
    ...
    <div class="mb-3">
        ...
        <div class="input-group mb-3">
            <input required name="alamat_pemberi_hibah" type="text" class="form-control" id="exampleFormControlInput1"  placeholder="alamat_pemberi_hibah">
        </div>
    </div>
    ...
    <div class="mt-3 mb-3">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text">Rp.</span>
            <input required name="total_penghasilan_bersih" type="number" class="form-control" id="exampleFormControlInput1"  placeholder="total_penghasilan_bersih">
        </div>
    </div>
