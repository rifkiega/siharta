...
<div class="container-fluid px-4">
    ...
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Tempat / Tanggal Nikah</label>
        <div class="row">
            <div class="col">
              <input type="text" class="form-control" placeholder="tempat" aria-label="tempat">
            </div> /
    ...
    <div class="mt-3 mb-3">
        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Wajib Diisi Jika Pekerjaan Non PNS">
    </div>
