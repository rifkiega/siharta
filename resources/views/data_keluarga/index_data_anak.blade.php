        ...
        <div class="card-body">
            <form action="/tambah_data_keluarga_anak" method="POST">
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="text" name="nama_anak" class="form-control" id="exampleFormControlInput1"
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="text" name="alamat_rumah" class="form-control" id="exampleFormControlInput1"
                ...
                <div class="mb-3">
                    <center>
                        ...
                        <a href="/print_data_anak" class="btn btn-success">Print</a>
