...
<body>
    ...
    <div id="halaman">
        @php
        $dataPribadi = App\Models\DataPribadi::where('user_id', $id)->first();
        @endphp
        ...
        <table style="margin-bottom: 20px; font-size: 12px; margin-top: 10px;">
            ...
            @php
                // ================== Kekayaan ==================
                $totalHartaTidakBergerak = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Tidak Bergerak')->sum('detail_laporans.isi_7');
                $totalHartaBergerakTransportasi = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Kendaraan')->sum('detail_laporans.isi_8');
                $totalSuratBerharga = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Surat Berharga')->sum('detail_laporans.isi_6');
                $totalHutang = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Hutang')->sum('detail_laporans.isi_5');
                $totalUangTunai = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Uang Tunai')->sum('detail_laporans.isi_6');
                $totalPiutang = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Piutang')->sum('detail_laporans.isi_5');
                
                // ================== Penghasilan ================
                $totalSuamiIstri = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Data Suami/Istri')->sum('detail_laporans.isi_4');
                $totalPenghasilanProfesi = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Penghasilan Profesi')->sum('detail_laporans.isi_3');
                $totalPenghasilanJabatan = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Penghasilan Jabatan')->sum('detail_laporans.isi_5');
                $totalPenghasilanHibah = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Penghasilan Hibah')->sum('detail_laporans.isi_3');
                // ================== Pengeluaran ================
                $totalPengeluaranRutin = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Laporan Pengeluaran')->sum('detail_laporans.isi_1');
                $totalPengeluaranLainnya = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Laporan Pengeluaran')->sum('detail_laporans.isi_2');
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $hartaTidakBergerak = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Tidak Bergerak')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $hartaBergerakTransportasi = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Kendaraan')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $hartaBergerakUsaha = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Usaha')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $hartaBergerakLogam = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Logam')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $suratBerharga = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Surat Berharga')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $uangTunai = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Uang Tunai')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $piutang = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Piutang')->get();
                $i = 1;
                $totalSaldoPiutang = 0;
            @endphp
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $hutang = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Harta Hutang')->get();
                $i = 1;
                $totalSaldoHutang = 0;
            @endphp
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $penghasilanJabatan = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Penghasilan Jabatan')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $penghasilanProfesi = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Penghasilan Profesi')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $penghasilanHibah = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Penghasilan Hibah')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $dataSuamiIstri = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Data Suami/Istri')->get();
                $i = 1;
    ...
    <table id="table-1" class="table table-bordered" style="font-size: 12px; border: 1px solid;">
        ...
        <tbody>
            ...
            @php
                $dataAnak = App\Models\DetailLaporan::join('laporans', 'detail_laporans.laporan_id', '=', 'laporans.id')->where('laporans.user_id', $id)->where('detail_laporans.type', 'Data Anak')->get();
                $i = 1;
            @endphp
