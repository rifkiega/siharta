...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Laporan Baru / Data Keluarga</li>
    </ol>
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="/data_keluarga">DATA KELUARGA</a>
        </li>
        <li class="nav-item">
    ...
    <div class="mb-3">
        <center>
            ...
            <a href="/harta_kekayaan" class="btn btn-success">Lanjutkan</a>
        </center>
    </div> 
