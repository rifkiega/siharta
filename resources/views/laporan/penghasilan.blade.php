...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Laporan Baru / Penghasilan</li>
    </ol>
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="/penghasilan">PENGHASILAN</a>
          </li>
          <li class="nav-item">
    ...
    <div class="mb-3">
        <center>
            ...
            <a href="/pengeluaran" class="btn btn-success">Lanjutkan</a>
        </center>
    </div> 
