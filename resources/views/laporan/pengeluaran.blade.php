...
<div class="container-fluid px-4">
    ...
    <ul class="nav nav-tabs">
        <li class="nav-item">
          <a class="nav-link" aria-current="page" href="/pengeluaran">DATA PRIBADI</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="/pengeluaran">PENGELUARAN</a>
          </li>
          <li class="nav-item">
    ...
    <div class="mb-3">
        <center>
            ...
            <a href="/selesai" class="btn btn-success">Lanjutkan</a>
        </center>
    </div> 
