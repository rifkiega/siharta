            ...
            <form action="/tambah_harta_piutang" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="atas_nama" type="atas_nama" class="form-control"
                            id="exampleFormControlInput1" placeholder="atas_nama">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="hubungan_keluarga" type="hubungan_keluarga_relasi" class="form-control"
                            id="exampleFormControlInput1" placeholder="hubungan_keluarga_relasi">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="nama_bank_lembaga_penyimpanan" type="hubungan_keluarga_relasi"
                            class="form-control" id="exampleFormControlInput1"
                            placeholder="nama_bank_lembaga_penyimpanan">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="no_rekening" type="no_rekening" class="form-control"
                            id="exampleFormControlInput1" placeholder="no_rekening">
                    </div>
                </div>
