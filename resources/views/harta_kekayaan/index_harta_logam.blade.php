        ...
        <div class="card-body">
            <form action="/tambah_harta_logam" method="POST">
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="text" name="jenis_harta" class="form-control" id="exampleFormControlInput1"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="jumlah_satuan" class="form-control" id="exampleFormControlInput1"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="harga_perolehan" class="form-control" id="exampleFormControlInput1"
