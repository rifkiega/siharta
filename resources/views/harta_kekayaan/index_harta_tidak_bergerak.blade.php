            ...
            <form action="/tambah_harta_tidak_bergerak" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="jenis_harta" type="text" class="form-control"
                            id="exampleFormControlInput1" placeholder="jenis_harta">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="luas_tanah" type="number" class="form-control"
                            id="exampleFormControlInput1" placeholder="luas_tanah">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="atas_nama" type="text" class="form-control" id="exampleFormControlInput1"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="alamat" type="text" class="form-control" id="exampleFormControlInput1"
                            placeholder="alamat">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="tahun_perolehan" type="date" class="form-control"
                            id="exampleFormControlInput1" placeholder="tahun_perolehan">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="harta_perolehan" type="text" class="form-control"
                            id="exampleFormControlInput1" placeholder="harta_perolehan">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input required name="harga_peroleh" type="number" class="form-control"
                            id="exampleFormControlInput1" placeholder="harga_peroleh">
                    </div>
                </div>
                ...
                <div class="mt-3 mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input required name="total_njop_saat_pelaporan" type="number" class="form-control"
                            id="exampleFormControlInput1" placeholder="total_njop_saat_pelaporan">
                    </div>
                </div>
