        ...
        <div class="card-body">
            <form action="/tambah_harta_uang_tunai" method="POST">
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input type="text" name="jenis_kas" class="form-control" id="exampleFormControlInput1"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nomer_rekening" class="form-control" id="exampleFormControlInput1"
                        placeholder="Nomer Rekening / Polis">
                </div>
