...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Laporan Baru / Harta Kendaraan</li>
    </ol>
        ...
        <div class="card-body">
            <form action="/tambah_harta_kendaraan" method="POST">
                ...
                <div class="mt-3 mb-3">
                    ...
                    <input required name="jenis_tranportasi" type="text" class="form-control"
                        id="exampleFormControlInput1" placeholder="Jenis Tranportasi">
                </div>

                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">No. Kendaraan / Polisi</label>
                    <input required name="nomer_kendaraan" type="text" class="form-control"
                        id="exampleFormControlInput1" placeholder="Nomer Kendaraan">
                </div>

                <div class="mt-3 mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Merk & Mobil</label>
                    <input required name="merk_model" type="text" class="form-control" id="exampleFormControlInput1"
                        placeholder="Merk Mobil">
                </div>

                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Tahun Pembuatan & Perolehan</label>
                    <input required name="tahun_pembuatan" type="date" class="form-control"
                        id="exampleFormControlInput1" placeholder="Tahun Rakit dan Perolehan">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input required name="hubungan_keluarga" type="text" class="form-control"
                        id="exampleFormControlInput1" placeholder="Hubungan Keluarga">
                </div>

                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Nilai Perolehan</label>
                    <input required name="nilai_perolehan" type="number" class="form-control"
                        id="exampleFormControlInput1" placeholder="Nilai Perolehan">
                </div>
